  ...
  return (
    <div className="flex flex-row justify-center items-center mt-10 gap-6 md:gap-10 lg:gap-12 font-serif">
      ...
      <div className="flex flex-col justify-center items-center w-1/3">
        <div className="w-24 h-24 sm:w-40 sm:h-40 md:w-48 md:h-48 md:rounded-full overflow-hidden flex-shrink-0">
          <img
        ...
        <h2 className="text-lg text-blue font-bold mt-2 mb-1">Paulina</h2>
      ...
      <div className="flex flex-col justify-center items-center w-1/3">
        ...
        <h2 className="text-lg text-blue font-bold mt-2 mb-1">Carlos</h2>
      ...
      <div className="flex flex-col justify-center items-center w-1/3">
        ...
        <h2 className="text-lg text-blue font-bold mt-2 mb-1">Rigoberto</h2>
        <p className="text-sm text-gray-600 text-center">Role</p>
      </div>
    </div>
  );
