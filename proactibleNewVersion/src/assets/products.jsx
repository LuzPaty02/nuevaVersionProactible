...
const productData = [
  ...
  {
    titulo: "Pie Sach",
    descripcion: "Pie de tobillo sólido  madera. Talla 21 a 28. Con partido de sandalia. Hecho en México. Cuenta con descuento con garantía extendida.",
    imagePath: "src/assets/images/images/venta_componentes_imgs/pie_sach.png", 
  },
  {
    titulo: "Funda protectora CONFETTI II CANVAS",
    descripcion: "Funda protectora para prótesis transfemoral de la marca ID ethnos. Pesa aproximadamente 400 gramos, es compatible con varias rodillas y resistente contra el agua. CP006",
    imagePath: "src/assets/images/images/venta_componentes_imgs/fundaprotectora_confetti.png",
  },
  {
    titulo: "Bolsa de fácil colocación",
    descripcion: "Bolsa de fácil colocación de prótesis para amputación transfemoral (por arriba de rodilla)", 
    imagePath: "src/assets/images/images/venta_componentes_imgs/bolsa_facil_colocacion.png",
  },
  {
    titulo:"Pie articulado de titanio (Single Axis)",
    descripcion: "Pie con articulación de titanio. Tallas 22 a 28. Cuenta con descuento en caso de tener garantía extendida.",
    imagePath: "src/assets/images/images/venta_componentes_imgs/pie_titanio.png",
